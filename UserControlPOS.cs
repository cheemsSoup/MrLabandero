...
namespace MrLabanderoLaundry
{
    public partial class UserControlPOS : UserControl
    {
        ...
        private void rbFullServices_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void rbWashOnly_CheckedChanged(object sender, EventArgs e)
        {
            if (rbWashOnly.Checked)
            {
                panelFullServices.Visible = false;
        ...
        // ─────────────────────────────────────────
        // ITEM TYPE - Radio Buttons (Full Service)
        // ─────────────────────────────────────────
        ...
        // ─────────────────────────────────────────
        // ADD-ONS - NUD ValueChanged Events
        // ─────────────────────────────────────────
        ...
        private bool ValidateForm()
        {
            ...
            if (!rbFullServices.Checked && !rbWashOnly.Checked && !rbDryFold.Checked)
            {
        ...
        private void btnProceed_Click(object sender, EventArgs e)
        {
            ...
            // TODO: Open payment form here
            // frmPayment payForm = new frmPayment(total);
            // payForm.ShowDialog();
        }
